...
--
-- Tabellenstruktur f�r Tabelle `buslinie`
--
...
--
-- Tabellenstruktur f�r Tabelle `haltestelle`
--
...
(2, 'Hannover, Steintor'),
(3, 'Hameln, Bahnhof'),
(4, 'Hildesheim, Dammtor'),
(5, 'Hildesheim, Hildesheimer Wald'),
(6, 'Hildesheim, Stadtfeld'),
(7, 'Hameln, HSW'),
...
--
-- Tabellenstruktur f�r Tabelle `linienabfolge`
--
...
--
-- Daten f�r Tabelle `linienabfolge`
--
...
--
-- Tabellenstruktur f�r Tabelle `verbindung`
--
...
--
-- Indizes f�r die Tabelle `buslinie`
--
...
--
-- Indizes f�r die Tabelle `haltestelle`
--
ALTER TABLE `haltestelle`
  ADD PRIMARY KEY (`hid`);

--
-- Indizes f�r die Tabelle `linienabfolge`
--
...
--
-- Indizes f�r die Tabelle `verbindung`
--
...
--
-- AUTO_INCREMENT f�r Tabelle `buslinie`
--
ALTER TABLE `buslinie`
...
--
-- AUTO_INCREMENT f�r Tabelle `haltestelle`
--
ALTER TABLE `haltestelle`
  MODIFY `hid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT f�r Tabelle `linienabfolge`
--
ALTER TABLE `linienabfolge`
...
--
-- AUTO_INCREMENT f�r Tabelle `verbindung`
--
ALTER TABLE `verbindung`
